...
-- ('Zadania - szkoła podstawowa', 'Zadania z tematyki szkoły podstawowej', 'zadania-szkola-podstawowa', 6),
-- ('Zadania - szkoła średnia', 'Zadania z tematyki szkoły średniej', 'zadania-szkola-srednia', 7),
-- ('Zadania - matura', 'Zadania z tematyki szkoły średniej. Poziom maturalny', 'zadania-matura', 8),
